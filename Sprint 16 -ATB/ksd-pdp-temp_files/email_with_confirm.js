    ...
    $.fn.emailWithConfirm = function (options) {
        ...
        return this.each(function () {
            var $this,
                ...
                initHeight,
                newHeight,
                doneOnce = false,   // prevents box height from resetting multiple times
            ...
            $emailInput.bind('click', function () {
                ...
                if (!doneOnce) {
                    ...
                    initHeight = parseInt($wrapperParent.css('height'));
                    newHeight = initHeight + 70 + 'px';
                    $wrapperParent
					.css({
					    'position': 'absolute',
					    'top': offsetParent.top - 10,
