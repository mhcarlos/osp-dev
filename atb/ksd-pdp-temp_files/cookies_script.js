...
function decode(mystring) { //New decoder
...
////////////// Start of HeaderCookieHelper ////////////////////////////////
	...
	function CardInfoMessageEx(userCookie, cookieStringCreditInfo, cookieStringPreApprovedOfferDeclined, ccLinkID, ccImageID) {	
		...
		if(ccLink == null || ccImage == null) {
			return;}
		var urlBase = "https://secureimages.plussizetech.com/images/site_images/KSD/";
		var imagePre = urlBase + "111_btn_preapproved_160x21.gif";
	...
	function CardInfoMessageNew(userCookie, cookieStringCreditInfo, cookieStringPreApprovedCardType, ccLinkID,ccLink1ID, ccImageID) {	
		var cookieValueCreditInfo  = GetUserSubCookieValue(userCookie, cookieStringCreditInfo);
        ...
        var urlBase;
 		     if(window.location.protocol.indexOf("s")>0)
		       {urlBase = "https://secureimages.plussizetech.com/images/site_images/KSD/";}
		else
		 {urlBase = "http://images.plussizetech.com/images/site_images/KSD/";}					
		//ToDo change the image into imageOTB	
		var imageOTB = urlBase + "1024_KSD_CC_FOOTER_OTB.gif";
		var imagePre;
		var imageStandard = urlBase + "1024_KSD_CC_FOOTER_NO_LOGIN.gif";
	 	    if (cookieValuePreApprovedCardType != null && cookieValuePreApprovedCardType.length > 0) {
		    if (cookieValuePreApprovedCardType == "plcc") {
		        imagePre = urlBase + "1024_KSD_CC_FOOTER_PRE.gif"
		    } else if (cookieValuePreApprovedCardType == "cobr") {
		        imagePre = urlBase + "1024_KSD_CC_FOOTER_PRE_COBR.gif"
		    } else {
      ...
      imagePre = imageStandard;
			...
			var creditIndicator  =  cookieValueCreditInfo.substring(startIndex, endIndex);
 			     if (creditIndicator.toUpperCase() == "A") {
				        ccLink.href = "/Account/Acct_CreditCards.aspx?MEC=KS07_003_04_01_01";
				        ccLink1.href ="/Account/Acct_CreditCards.aspx?MEC=KS07_003_04_01_01";
				        ccImage.src = imageOTB;
			}else if (creditIndicator.toUpperCase() == "P" ) {				
			  if (cookieValuePreApprovedCardType != null && cookieValuePreApprovedCardType.length > 0) {
		      if (cookieValuePreApprovedCardType == "plcc")   {
                    ccLink.href = "/Account/Acct_PreQualifiedOffer_plcc.aspx?MEC=KS07_003_01_01_01";
                    ccLink1.href = "/Account/Acct_PreQualifiedOffer_plcc.aspx?MEC=KS07_003_01_01_01";
		          } else if (cookieValuePreApprovedCardType == "cobr") {
		                ccLink.href = "/Account/Acct_PreQualifiedOffer_cobrnd.aspx?MEC=KS07_003_02_01_01";
		                ccLink1.href = "/Account/Acct_PreQualifiedOffer_cobrnd.aspx?MEC=KS07_003_02_01_01";
		            } else {
		                ccLink.href = "/Account/Apply_CreditCard.aspx?MEC=KS07_003_03_01_01";
		                ccLink1.href = "/Account/Apply_CreditCard.aspx?MEC=KS07_003_03_01_01";
  }} else {
      ccLink.href = "/Account/Apply_CreditCard.aspx?MEC=KS07_003_03_01_01";
      ccLink1.href = "/Account/Apply_CreditCard.aspx?MEC=KS07_003_03_01_01";
		   }ccImage.src = imagePre;
	 ...
	 if(ccLink!=null) {
		...
		//var imagePre = urlBase + "footer_z2_credit_preQual.gif";
		var imagePre = urlBase + "111_btn_preapproved_160x21.gif";
