...
bouncex.website = {"cae":false,"ei":0,"cookie_name":"bounceClientVisit265","base_host":"bounceexchange.com","vars":{"logged_in":{"val":"GetLoginStatus('vendor')?'true':'false'","polling":"none","default":""},"items_in_cart":{"val":"parseInt(document.getElementById('ShoppingBagCount').innerHTML.replace('(',''))","polling":"none","default":""},"category":{"polling":"none","persist":"no","val":"document.getElementById('on')?(document.getElementById('on').textContent||document.getElementById('on').innerText):''","default":""},"foot_email_sub":{"polling":"all","persist":"permanent","val":"bouncex.vars.foot_email_sub || $('.email-confirm-popup').length > 0;","default":"false"},"show_cart_annotation":{"polling":"all","persist":"no","val":"window.top.location.href.indexOf('Checkout')>=0 && jQuery('input[id*=email_promotions]').is(':visible');\n","default":"false"},"cart_value":{"polling":"none","persist":"visit","val":"(function(){\n    if( window.location.href.indexOf(\"\/ShoppingBag.aspx\") !== -1 ) {\n        return +$('#itemized-total > .amount:last-child > span').text().slice(1);\n    } else {\n        return bouncex.vars.cart_value;\n    }\n})();","default":"0"},"show_reg_anno":{"polling":"all","persist":"no","val":"location.href.indexOf('acct_createprofile')>-1 && jQuery('input[id*=chkOptIn]').is(':visible');","default":"false"}},"acts":[],"pi":1000,"ct":"bind_to_subdomain","tcjs":"","cjs":"if(window.top.location.href.indexOf('Checkout\/Checkout')>=0){\n  var campaign = false;\n  jQuery(document).on('click','#shipping_guest_use_email_promotions',function(data){\n    if(bouncex.campaigns){\n      if (bouncex.campaigns['66177']) campaign = '66177';\n      if (bouncex.campaigns['66184']) campaign = '66184';\n      if (bouncex.campaigns['66185']) campaign = '66185';\n    }\n    if($(this).is(':checked')){\n      bouncex.close_bAnn();\n    }else{\n      bouncex.open_bAnn();\n    }\n  });\n}\n\nbouncex.close_bAnn = function(){\n    if (bouncex.campaigns['66177']) bouncex.show_ad('66183');\n    bouncex.close_ad(campaign);\n};\n\nbouncex.open_bAnn = function(){\n    bouncex.show_ad(campaign);\n    if (bouncex.campaigns['66177']) bouncex.close_ad('66183');\n};\n\n\n\/\/SDO: Reg Anno Code\nif (window.top.location.href.indexOf('acct_createprofile') > -1) {\n  var campaign = false;\n  jQuery(document).on('click', '#ctl00_GlobalBodyPlaceHolder_chkOptIn', function (data) {\n    if (bouncex.campaigns) {\n      if (bouncex.campaigns['72931']) campaign = '72931';\n      if (bouncex.campaigns['72932']) campaign = '72932';\n      if (bouncex.campaigns['72933']) campaign = '72933';\n    }\n    if (jQuery(this).is(':checked')) {\n      bouncex.close_bAnn_reg();\n    } else {\n      bouncex.open_bAnn_reg();\n    }\n  });\n}\n\nbouncex.close_bAnn_reg = function () {\n  if (bouncex.campaigns['72931']) bouncex.show_ad('72937');\n  bouncex.close_ad(campaign);\n};\n\nbouncex.open_bAnn_reg = function () {\n  bouncex.show_ad(campaign);\n  if (bouncex.campaigns['72931']) bouncex.close_ad('72937');\n};","PMI":500,"PDI":1000,"PMR":30,"force_https":false,"waypoints":false,"gai":"","ots":0,"sd":0,"aco":{"first_party_limit":"3500"},"id":265,"campaign_id":0,"tpc":0,"uwc":0,"domain":"","bau":"api.bounceexchange.com","is_preview":false,"mas":1,"map":1,"burls":[],"ibx":{"cjs":"bouncex.ibx.track('event','bouncex conversion');","miw":"1","mibcx":1,"te":0,"tjs":"\/\/ KINGSIZEDIRECT CODE\n\nbouncex.ibx.monitor_quickview_item = function (event_name) {\n    clearInterval(window.bouncex.ibx.cvar.closeInt);\n    window.bouncex.ibx.cvar.intCheck = setInterval(function(){\n\n        if (!jQuery('div.quickview-container').is(':visible')) return;\n        var quickview_data = {\n            creative: jQuery('#alt_main_image_0').find('img.alt-main-image').attr('src'),\n            copy: jQuery('span#lblProductName').text(),\n            sku: jQuery('span#lblQONumber').text()\n        };\n        window.bouncex.ibx.track('item', quickview_data.copy, quickview_data);\n        window.bouncex.ibx.track('event', event_name);\n        window.bouncex.ibx.track('event','viewed item');\n        window.bouncex.ibx.monitor_quickview_item_clear();\n    }, 500);\n}\n\nbouncex.ibx.monitor_quickview_item_clear = function () {\n    clearInterval(window.bouncex.ibx.cvar.intCheck);\n    window.bouncex.ibx._log('monitor quickview cleared');\n    window.bouncex.ibx.cvar.closeInt = setInterval(function(){\n        if (jQuery('div.quickview-container').is(':visible')) return;\n        window.bouncex.ibx.monitor_quickview_item('viewed quickview ' + window.bouncex.ibx.cvar.page_type);\n    }, 500);\n}\n\n\n\/* set custom variables *\/\nvar product_page = jQuery('meta[property=\"og:type\"]').attr('content')=='product'\n    ,category_page = window.top.location.href.indexOf('DeptId') > -1\n    ,search_page = jQuery('div.search-header').length > 0;\nbouncex.ibx.cvar.page_type = product_page ? 'product' : (category_page ? 'category' : (search_page ? 'search' : ''));\n\n\/*Tracking URL users*\/\nbouncex.ibx.user(bouncex.ibx._getparam('email'));\n\n\/* track item *\/\nif(bouncex.ibx.cvar.page_type == 'product'){\n  var data = { \n      creative: jQuery('meta[property=\"og:image\"]').attr('content')\n      ,copy: jQuery('meta[property=\"og:title\"]').attr('content')\n      ,subcopy: jQuery('meta[property=\"og:description\"]').attr('content')\n,sku: jQuery('.pdp-item-number').text()\n    };\n  bouncex.ibx.track('item',data.sku,data);\n  bouncex.ibx.track('event','viewed item');\n\n  bouncex.ibx.monitor_quickview_item('viewed quickview product');\n\n} else if(bouncex.ibx.cvar.page_type == 'category' || bouncex.ibx.cvar.page_type == 'search') {\n    bouncex.ibx._log('current page: '+bouncex.ibx.cvar.page_type);\n    bouncex.ibx.monitor_quickview_item('viewed quickview '+ bouncex.ibx.cvar.page_type);\n}\n\n\n\/* auto-track NON-AJAX cart events *\/\nbouncex.ibx.get_cart_count = function() {\n    return jQuery('#ShoppingBagCount').text().replace(\/[^0-9\\\\.]\/g,'');\n}\nbouncex.ibx.process_cart_events = function(cart) {\n    var old_count = parseInt(bouncex.ibx._cookies.read('_ccnt')),\n        new_count = parseInt(cart.count),\n        track_event = false;\n    if (isNaN(old_count)) old_count = 0;\n    if (isNaN(new_count)) new_count = 0;\n    if (old_count > 0 && new_count == 0) {\n        track_event = 'cart emptied';\n    } else if (old_count > new_count) {\n        track_event = 'removed from cart';\n    } else if (old_count < new_count) {\n        track_event = 'added to cart';\n    }\n    if (track_event) {\n        bouncex.ibx.track('event', track_event, {\n            old_count: old_count,\n            new_count: new_count\n        });\n        bouncex.ibx._cookies.create('_ccnt', new_count);\n    }\n    return track_event;\n}\nbouncex.ibx.process_cart_events({\n    count: bouncex.ibx.get_cart_count()\n});\n\nbouncex.ibx.get_cart_count = function() {\n  return jQuery('#ShoppingBagCount').text().replace(\/[^0-9\\\\.]\/g,'');\n}\nbouncex.ibx.cvar.cart_count = bouncex.ibx.get_cart_count();\nibx_iic_poll = setInterval(function() {\n    var item_count = bouncex.ibx.get_cart_count(),\n        track_event = false;\n    if (isNaN(item_count) || isNaN(bouncex.ibx.cvar.cart_count)) {\n        return;\n    } else if (bouncex.ibx.cvar.cart_count > 0 && item_count == 0) {\n        track_event = 'cart emptied';\n    } else if (item_count < bouncex.ibx.cvar.cart_count) {\n        track_event = 'removed from cart';\n    } else if (item_count > bouncex.ibx.cvar.cart_count) {\n        track_event = 'added to cart';\n    }\n    if (track_event) {\n        bouncex.ibx.track('event', track_event, {\n            old_count: bouncex.ibx.cvar.cart_count,\n            new_count: item_count\n        });\n        bouncex.ibx.cvar.cart_count = item_count;\n    }\n}, 1000);","cart_rep":{"get":"","set":""}}};
